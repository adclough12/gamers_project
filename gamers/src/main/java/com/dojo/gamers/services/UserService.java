...
import com.dojo.gamers.repositories.UserRepository;
...
public class UserService {
    ...
    public User register(User newUser, BindingResult result) {
    	...
    	Optional<User> userLookUp = repo.findByEmail(newUser.getEmail());
    ...
    public User login(LoginUser newLogin, BindingResult result) {
    	...
    	Optional<User> userLookUp = repo.findByEmail(newLogin.getEmail());
    	if (!userLookUp.isPresent()) {
